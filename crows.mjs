...
Hooks.once("init", async () => {
  ...
  game.settings.registerMenu("fvtt-crows-system", "setupGuide", {
    ...
    hint: "Enable the PDF importer, select your packet folder, and bring your playtest content into Foundry.",
    icon: "fas fa-book-open", type: CrowsSetupGuide, restricted: false
  });

  // GM menu: extract and review the user's playtest PDFs.
  game.settings.registerMenu("fvtt-crows-system", "importer", {
    name: "Import Playtest Content",
    label: "Open Importer",
    hint: "Open Crows PDF Importer to extract and review your own MCDM playtest packet.",
    icon: "fas fa-download",
    type: CrowsPDFImporter,
    restricted: true
  });
  ...
  game.settings.registerMenu("fvtt-crows-system", "characterCreator", {
    name: "Character Creator", label: "Create a Crow", hint: "Create a new crow from your imported playtest content.",
